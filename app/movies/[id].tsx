...
//tive um erro aqui a classe name nao funciona se usa ' tem que usa "
...
const MovieDetails = () => {
     ...
     //receber os duracao do fulme pela api e transforma cada 60m para 1h
          ...
          <View className='bg-primary flex-1'>
               <ScrollView contentContainerStyle={{ paddingBottom: 80 }}>
                    ...
                    <View className='flex-col items-start justify-center mt-5 px-5'>
                         ...
                         <View className='flex-row items-center bg-dark-100 px-2 py-1 rounded-mb gap-x-1 mt-2'>
                         ...
                         <View className='flex flex-row justify-between w-1/2'>
                              ...
                              <MovieInfo label='Revenue' value={movie?.revenue ? `$${(movie.revenue / 1_000_000).toFixed(3)}` : 'N/A'} />
                         </View>
